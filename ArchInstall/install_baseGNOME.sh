...
pacman -S dosfstools mtools os-prober networkmanager network-manager-applet wpa_supplicant wireless_tools dialog mesa xorg-xinit xorg-server xorg-apps xf86-video-intel nvidia nvidia-settings gnome gnome-extra flatpak gnome-terminal firefox neofetch nasm git wget curl
